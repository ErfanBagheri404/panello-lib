...
const translations: Translations = {
  ...
  fa: {
      ...
      noRemindersMessage: "برای افزودن اولین یادآوری، روی دکمه %dots% بالا کلیک کنید",
      cancelButton: "لغو",
      ...
      pause: "توقف",
      loadingResponse: "...",
      modelSwitchError: "به دلیل خطا، به %model% تغییر یافت. لطفاً دوباره تلاش کنید.",
      humorCommands: [
        "یک لطیفه بگو!",
      ...
      inviteMembersPrompt: "می‌خواهید عضو جدیدی به گروه خود دعوت کنید؟ با چند گام ساده این کار را انجام دهید!",
      inviteMembersNote: "(مطمئن شوید که نقش‌های گروه خود را تنظیم کرده‌اید و ایمیل عضو را دارید)",
      ...
      sidebar: {
        ...
        tasks: "وظایف",
        addTask: "+ افزودن",
        inviteDescription: "اعضای جدید به فضاهای عمومی، اسناد و داشبوردها دسترسی خواهند داشت",
        ...
        offline: "آفلاین",
        viewProfile: "مشاهده پروفایل",
        accessRestricted: "شما هنوز به این فضای کاری دعوت نشده‌اید. لطفاً برای دسترسی با مدیر خود تماس بگیرید。",
      },
      todayButton: "امروز",
      filterButton: "فیلتر",
      editButton: "ویرایش",
